...
import { EntangleIcon } from "@/icons/Entangle";
...
export const SIDEBAR_BUNDLES = [
  ...
  { display_name: "Aspis", name: "aspis", icon: "ASPIS" },
  { display_name: "Entangle", name: "entangle", icon: "Entangle" },
  { display_name: "Binance", name: "binance", icon: "Binance" },
  // Остальные инструменты не используются и закомментированы:
  /*
  { display_name: "LangChain", name: "langchain_utilities", icon: "LangChain" },
  { display_name: "AgentQL", name: "agentql", icon: "AgentQL" },
  { display_name: "AssemblyAI", name: "assemblyai", icon: "AssemblyAI" },
  { display_name: "DataStax", name: "astra_assistants", icon: "AstraDB" },
