    ...
    () =>
      description === "" || !description ? (
        ...
        <MemoizedMarkdown
          linkTarget="_blank"
          className={cn(
            "markdown flex w-full flex-col text-[13px] leading-5 word-break-break-word !text-white [&_pre]:whitespace-break-spaces [&_pre]:!bg-code-description-background [&_pre_code]:!bg-code-description-background",
            mdClassName,
          )}
        >
          {String(description)}
